...
/// - La unicidad de NumeroMotor y NumeroChasis se valida/garantiza en Infraestructura (EF + índice único)
/// </summary>
public class Automovil
{
    ...
    /// <summary>
    /// Actualización controlada (PUT total o actualización parcial simple).
    /// La unicidad se verifica en Application/Repository antes de persistir.
    /// </summary>
    public void Update(string? color = null, string? numeroMotor = null, string? numeroChasis = null,
                       string? marca = null, string? modelo = null, int? fabricacion = null)
    {
